...
DROP DATABASE IF EXISTS frs_olap_db;
-- create the tables
...
INSERT INTO frs_olap_db.flight(flight_ID,departure_date, arrival_date,src_airport_code,dest_airport_code)
SELECT flight_id, departure_date, arrival_date, src_airport_code, dest_airport_code
FROM cst363.flight;


INSERT INTO frs_olap_db.flight_reservations(flight_ID, passenger_ID)
