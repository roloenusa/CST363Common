...
print('      <input type="text" name="name" class="form-control" placeholder="item name">')
print('    </div>')
print('  </div>')
print('  <div class="form-group row">')
print('    <label class="col-sm-2 col-form-label">Description</label>')
print('    <div class="col-sm-3">')
print('      <input type="text" name="description" class="form-control" placeholder="item description">')
print('    </div>')
print('  </div>')
print('  <div class="form-group row">')
...
print('    <div class="col-sm-3">')
print('      <input type="text" name="cost" class="form-control" placeholder="item cost">')
print('    </div>')
print('  </div>')
print('')
print('  <div class="form-group row">')
